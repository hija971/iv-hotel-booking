      ...
      <div className="grid grid-cols-4">
        <div className="col-span-1">
          <div className="flex flex-col">
            <button
              className={`p-4 pl-0 text-start font-bold border-b border-gray-300 focus:outline-none ${
                activeTab === "overview" ? "text-[#e1bd85]" : ""
              }`}
            ...
            <button
              className={`p-4 pl-0 text-start font-bold border-b border-gray-300 focus:outline-none ${
                activeTab === "amenities" ? "text-[#e1bd85]" : ""
              }`}
            ...
            <button
              className={`p-4 pl-0 text-start font-bold border-b border-gray-300 focus:outline-none ${
                activeTab === "calendar" ? "text-[#e1bd85]" : ""
              }`}
          ...
          {activeTab === "overview" && (
            <div className="overview p-4 pr-0">
              <div className="room-detail_overview">
                <h5 className="uppercase font-medium mb-2">
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2">
                      <p className="price text-center">
                        <span className="amout text-center">$320</span>
                      </p>
                    </td>
                    <td className="border px-4 py-2">
                      <p className="price text-center">
                        <span className="amout text-center">$23</span>
                      </p>
                    </td>
                    <td className="border px-4 py-2">
                      <p className="price text-center">
                        <span className="amout text-center">$120</span>
                      </p>
                    </td>
                    <td className="border px-4 py-2">
                      <p className="price text-center">
                        <span className="amout text-center">$100</span>
                      </p>
                    </td>
                    <td className="border px-4 py-2">
                      <p className="price text-center">
                        <span className="amout text-center">$89</span>
                      </p>
                    </td>
                  </tr>
                  <tr>
