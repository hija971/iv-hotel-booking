      ...
      <div className="w-100% h-full flex flex-col justify-center items-center pt-10 bg-white">
        ...
        <div className="w-9/12 h-full mt-10 justify-center items-center">
          <div className="flex flex-row-reverse justify-center items-center">
            ...
            <div className="w-6/12 pl-10">
              <div class="">
                <h2 class="text-[#232323] text-4xl font-bold">
                  WHY GUEST CHOOSE LOTUS HOTEL?
                </h2>
                <div class="text-base text-[#333333] mt-5 pr-10">
                  <p>
                    ...
                    over the years,{" "}
                    <b>sometimes by accident, sometimes on purpose</b> (injected
                    humour and the like).
                  </p>
                </div>
              </div>
        ...
        <div className="w-9/12 h-full pb-5">
          <div className="pt-20 pb-20">
            <h2 class="text-[#232323] font-bold text-4xl text-center">
              TEAM MEMBER
            </h2>
            <p class="text-[#333333] text-xl text-center mt-4">
              Lorem Ipsum is simply dummy text of the printing
            </p>
          </div>
            ...
            <div className="grid grid-cols-4 gap-8">
              <div className="">
                ...
                <div class="mt-7 text-center">
                  <h2 className="text-[#232323] font-bold text-xl">
                    JESSICA ALBA
                  </h2>
                  <p className="mt-2 text-[#898989] text-base">
                    Manager lotus Hotel
                  </p>
                  <p className="mt-5 text-[#30373b] text-base">
                    Mea omnium explicari te, eu sit vidit harum fabellas, his no
                    legere feugaitper in laudem malorum epicuri, quod natum
                    evertitur ne per.
                  </p>
